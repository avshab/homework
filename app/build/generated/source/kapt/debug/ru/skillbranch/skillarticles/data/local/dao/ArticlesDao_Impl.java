...
public final class ArticlesDao_Impl implements ArticlesDao {
  ...
  public ArticlesDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfArticle = new EntityInsertionAdapter<Article>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Article value) {
        ...
        final long _tmp_1;
        _tmp_1 = __dateConverter.dateToTimestamp(value.getUpdatedAt());
  ...
  @Override
  public LiveData<List<ArticleItem>> findArticleItemsByCategoryIds(final List<String> categoryIds) {
  ...
  @Override
  public LiveData<List<ArticleItem>> findArticlesByTagId(final String tag) {
    final String _sql = "\n"
            + "        SELECT * FROM ArticleItem\n"
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"ArticleItem","article_tag_x_ref"}, false, new Callable<List<ArticleItem>>() {
      @Override
      public List<ArticleItem> call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
      ...
      public ArticleFull call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _tmpTags = __listConverter.toList(_tmp_4);
            ...
            _result = new ArticleFull(_tmpId,_tmpTitle,_tmpDescription,_tmpAuthor,_tmpCategory,_tmpShareLink,_tmpIsBookmark,_tmpIsLike,_tmpDate,_tmpContent,_tmpSource,_tmpTags);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public DataSource.Factory<Integer, ArticleItem> findArticlesByRaw(final SupportSQLiteQuery simpleSQLiteQuery) {
