...
class RepositoryTest1 {
    ...
    fun toggle_bookmark() {
        ...
        runBlocking {
            ...
            var personal = testDb.articlePersonalInfosDao().findPersonalInfosTest("5f27d6cf83218a001d059af0")
            ...
            personal = testDb.articlePersonalInfosDao().findPersonalInfosTest("5f27d6cf83218a001d059af0")
    ...
    fun increment_like() {
        ...
        runBlocking {
            ...
            val recordedRequest = server.takeRequest()
            Assert.assertEquals("POST", recordedRequest.method)
            Assert.assertEquals("/articles/5f27d6cf83218a001d059af0/incrementLikes", recordedRequest.path)
    ...
    fun decrement_like() {
        ...
        runBlocking {
            ...
            val recordedRequest = server.takeRequest()
            Assert.assertEquals("POST", recordedRequest.method)
            Assert.assertEquals("/articles/5f27d6cf83218a001d059af0/decrementLikes", recordedRequest.path)
            Assert.assertEquals("Bearer test_acess_token",recordedRequest.headers["Authorization"])
    ...
    fun refresh_comment_count() {
        ...
        runBlocking {
            ...
            val counts = testDb.articleCountsDao().findArticlesCountsTest("5f27d6cf83218a001d059af0")
    ...
    fun send_message() {
        ...
        runBlocking {
            ...
            var counts = testDb.articleCountsDao().findArticlesCountsTest("5f27d6cf83218a001d059af0")
            Assert.assertEquals(6, counts.comments)
            ...
            articleRepository.sendMessage(articleId = "5f27d6cf83218a001d059af0", message = "test", answerToMessageId = "5f37fd01bd6351001c26a71e")
            counts = testDb.articleCountsDao().findArticlesCountsTest("5f27d6cf83218a001d059af0")
